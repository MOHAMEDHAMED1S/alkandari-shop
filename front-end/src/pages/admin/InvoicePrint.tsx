...
const InvoicePrint: React.FC = () => {
    ...
    const loadOrder = async () => {
      ...
      try {
        ...
        if (response.data?.orders?.data && response.data.orders.data.length > 0) {
          setOrder(response.data.orders.data[0]);
        }
      } catch (error) {
  ...
  if (!order) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          <p className="text-red-600 mb-4">لم يتم العثور على الطلب</p>
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-100 print:bg-white">
        ...
        {/* محتوى الفاتورة */}
        <div className="print-content bg-white" dir="rtl">
          <div className="border border-gray-300">
            ...
            <div className="p-4">
              ...
              {/* تفاصيل الدفع */}
              {order.payment && (
                <div className="bg-gray-100 p-3 rounded border border-gray-300 mb-3">
