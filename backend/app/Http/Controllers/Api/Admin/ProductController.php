    ...
    public function store(Request $request)
    {
        try {
            $validator = Validator::make($request->all(), [
                ...
                'meta' => 'nullable', // Accept both array and object
            ...
            $product = Product::create([
                ...
                'has_sizes' => $request->boolean('has_sizes', false),
                ...
                'sizes' => $request->has_sizes ? $request->sizes : null,
            ]);
    ...
    public function update(Request $request, string $id)
    {
        try {
            ...
            $updateData = $request->only([
                ...
                'currency', 'is_available', 'category_id', 'images',
                'has_sizes', 'sizes'
            ]);
            
            // Handle meta to ensure it's always an object, not an array
            if ($request->has('meta')) {
                $updateData['meta'] = $request->meta ?: (object)[];
            }
