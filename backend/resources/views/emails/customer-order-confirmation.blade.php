                ...
                <tr>
                  <td style="padding:15px;">
                    ...
                    <div style="color:#666; font-size:13px;">
                      الكمية: {{ $item->quantity }} × {{ number_format($item->product_price, 2) }} {{ $order->currency ?? 'KWD' }}
                      @if($item->size)
                        <span style="background-color:#2563eb; color:#fff; padding:2px 6px; border-radius:4px; font-size:11px; margin-right:5px;">المقاس: {{ $item->size }}</span>
                      @endif
                    </div>
                  </td>
